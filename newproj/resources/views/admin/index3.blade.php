...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
          <a type="submit" href="{{route('admin.info')}}" class="btn btn-outline btn-primary">Add</a>
  ...
  <table width="10%" class="table table-striped table-bordered table-hover" id="dataTables-example">
      ...
      <tbody>
        ...
        <tr class="odd gradeX">
            <td>{{$pi->cont}}</td>
            <td>
              <a type="submit" href="{{route('admin.info.deletei',['id' => $pi->id])}}" class="btn btn-danger btn-primary">Delete</a>
              <a type="submit" href="{{route('admin.info.updatei',['id' => $pi->id])}}" class="btn btn-outline btn-primary">Update</a>
