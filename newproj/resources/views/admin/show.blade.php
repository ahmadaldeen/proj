	...
	<head>
      ...
      {!! Html::style("slider/css/component.css") !!}
		...
		<link href='http://fonts.googleapis.com/css?family=Raleway:200,400,600' rel='stylesheet' type='text/css'>
		 ...
		 <style>
		 .h {     margin: 32px auto 60px auto; text-align:center;}
		 </style>
   ...
   background-color: #fff
	...
	<body>
		  ...
		  <nav  class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
		    <div class="container">
		      <a  style="    color: #212529;"  class="navbar-brand js-scroll-trigger" href="#page-top">Start Bootstrap</a>
		      ...
		      <div class="collapse navbar-collapse" id="navbarResponsive">
		        <ul class="navbar-nav ml-auto my-2 my-lg-0">
		          <li class="nav-item">
		            <a style="    color: #212529;" class="nav-link js-scroll-trigger" href="{{Route('home.home')}}">Home</a>
		          </li>
		          <li class="nav-item">
		            <a  style="    color: #212529;"  class="nav-link js-scroll-trigger" href="#services">Services</a>
		          </li>
		          <li class="nav-item">
		            <a style="    color: #212529;"  class="nav-link js-scroll-trigger" href="#portfolio">Portfolio</a>
		          </li>
		          <li class="nav-item">
		            <a  style="    color: #212529;" class="nav-link js-scroll-trigger" href="#contact">Contact</a>
		          </li>
		        </ul>
		      </div>
		    </div>
		  </nav>
	  	<div style="height: 10%;"  class="container">
