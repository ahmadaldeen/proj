    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-10">
                      <a type="submit" href="{{route('admin.parfun')}}" class="btn btn-outline btn-primary">Add</a>
                ...
                <table width="10%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX">
                          ...
                          <td>{{$ph->price}} </td>
                          <td>{{$ph->type}} </td>
                          <td><img src="{{url('filter/' . $ph->path)}}" style="whidth:100px;height:100px"/></td>
                          <td>
                            <a type="submit" href="{{route('admin.parfun.deletep',['id' => $ph->id])}}" class="btn btn-danger btn-primary">Delete</a>
                            <a type="submit" href="{{route('admin.parfun.updatep',['id' => $ph->id])}}" class="btn btn-outline btn-primary">Update</a>
